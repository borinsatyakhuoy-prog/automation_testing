...
### 17. Performance - Formal SLA Coverage Across Every Feature Area (2026-07-21 baseline, 2026-07-22 full-coverage + formal SLA, same-day follow-up expanding coverage further and fixing a false-failure)
...
| Reports Consult - click-to-"generating" state | `performance/041_reports-consult-performance.spec.ts` | T6 | 1,640 ms | PASS |
| Reports Consult - `GET /api/report/{client}/` | same | T3 | 49 ms | PASS |
| **PDF Generation - click-to-completion** | `performance/042_pdf-generation-performance.spec.ts` | T7 | **20,082 ms** | PASS (within max 120,000 ms) |
...
| Admins - Unsupervised Asset Classes | `performance/045_admins-asset-classes-performance.spec.ts` | T2 | 105 ms | PASS |
| Admins - Firewall Configuration | `performance/046_admins-firewall-performance.spec.ts` | T2 | 105 ms | PASS |
...
| Markets - Currency tab + Add Currency dialog | `performance/049_markets-currency-performance.spec.ts` | T2/T5 | 104 ms / 119 ms | PASS |
...
| Client detail view - open / back | `performance/054_client-detail-view-performance.spec.ts` | T2 | 227 ms / 112 ms | PASS |
| **Report Lifecycle (main feature) - Consult** | `performance/055_report-lifecycle-sla-performance.spec.ts` | T6 | 1,587 ms | PASS |
| **Report Lifecycle (main feature) - Generate PDF** | same | T7 | 28,125 ms | PASS |
| Report Lifecycle (main feature) - Download | same | T8 | 318 ms | PASS |
