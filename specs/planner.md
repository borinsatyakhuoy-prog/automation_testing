...
| `GET /api/isin?month=2026-07` (2,438 rows), runs 3-6 (re-verification, see below) | same | T3 (P99) | 15 each (n=2-3 captured) | — / — / 3,403, 3,062, 3,636, 3,700 ms | **FAIL x4** - all four exceeded the 3,000 ms max |
