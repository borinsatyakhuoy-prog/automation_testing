...
/**
 * Category 6 of 10: Works of Art.
 * PORTED FROM: C:\Users\khuoybo\Downloads\Project\fapa_testing (tests/006_upload_model_oeuvre_art.spec.ts).
 * Includes a numeric-rounding fallback in the shared verifier (a price like
 * 334568.5 may render rounded to 334569 in the PDF) - see pdfExcelValidator.ts.
 *
...
const category = UPLOAD_CATEGORIES.find((c) => c.key === 'works-of-art')!;
