...
/**
 * Category 3 of 10: Passive (Liabilities).
 * PORTED FROM: C:\Users\khuoybo\Downloads\Project\fapa_testing (tests/003_upload_model_passif.spec.ts).
 *
...
const category = UPLOAD_CATEGORIES.find((c) => c.key === 'passive')!;
