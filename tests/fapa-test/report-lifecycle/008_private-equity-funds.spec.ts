...
/**
 * Category 8 of 10: Private Equity Funds.
 * PORTED FROM: C:\Users\khuoybo\Downloads\Project\fapa_testing (tests/008_upload_model_fond_private_equity.spec.ts).
 *
...
const category = UPLOAD_CATEGORIES.find((c) => c.key === 'private-equity-funds')!;
