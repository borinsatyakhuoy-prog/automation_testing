...
/**
 * Category 10 of 10: Private Debts.
 * PORTED FROM: C:\Users\khuoybo\Downloads\Project\fapa_testing (tests/010_upload_model_dette_privee.spec.ts).
 *
...
const category = UPLOAD_CATEGORIES.find((c) => c.key === 'private-debts')!;
