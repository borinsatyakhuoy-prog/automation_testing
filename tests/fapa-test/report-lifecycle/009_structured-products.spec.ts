...
/**
 * Category 9 of 10: Structured Products.
 * PORTED FROM: C:\Users\khuoybo\Downloads\Project\fapa_testing (tests/009_upload_model_product_structure.spec.ts).
 *
...
const category = UPLOAD_CATEGORIES.find((c) => c.key === 'structured-products')!;
