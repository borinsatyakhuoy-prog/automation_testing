...
/**
 * Category 4 of 10: Rental Management (Real Estate Assets).
 * PORTED FROM: C:\Users\khuoybo\Downloads\Project\fapa_testing (tests/004_upload_model_actif_immobilier.spec.ts).
 *
...
const category = UPLOAD_CATEGORIES.find((c) => c.key === 'rental-management')!;
